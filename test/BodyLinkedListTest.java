...
class BodyLinkedListTest {
    ...
    void removeCollidingWith() {
        BodyLinkedList removed = bll.removeCollidingWith(new Body(sun));
    ...
    @Test
    void pollFirstGetLast() {
        bll.pollFirst();
        bll.pollFirst();
        assertNull(bll.getLast());
    }

    @Test
    void pollLastGetFirst() {
        bll.pollLast();
        bll.pollLast();
        assertNull(bll.getFirst());
    }

    @Test
    void pollFirstGetFirst() {
        bll.pollFirst();
        bll.pollFirst();
        assertNull(bll.getFirst());
    }
    ...
    @Test
    void pollFirstOnceToMany() {
        bll.pollFirst();
        bll.pollFirst();
        assertNull(bll.pollFirst());
    }

    @Test
    void pollLastOnceToMany() {
        bll.pollLast();
        bll.pollLast();
        assertNull(bll.pollLast());
    }
}